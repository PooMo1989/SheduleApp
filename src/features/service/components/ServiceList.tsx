 ...
 * Story 2.3: Display list of services with edit/delete actions
 */
export function ServiceList({ onEdit, onAddNew }: ServiceListProps) {
                        ...
                        >
                            <div className="flex items-start justify-between">
                                ...
                                <div className="flex items-center gap-2">
                                    <button
                                        onClick={() => onEdit(service as Service)}
